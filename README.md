...
| HC338353/HC338353.sas | Job 53: multiple imputation (10 imputations, n=227 main sample); child anthropometry not imputed. |
...
| HC338364a/HC338364a.sas | Job 64a: BMIPCT_C3 ordinal pipeline parallel to job 64 for the PRS-complete imputed sample; Table 4a. |
...
**Generated on:** 2026-05-05 using `generate_md.R` by Alvaro Quijano-Angarita
