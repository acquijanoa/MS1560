...
proc printto log="&homepath.\code\HC338354c\HC338354c_&sysdate..log" 
				print = "&homepath.\code\HC338354c\HC338354c_&sysdate..lst" new; 
run;
...
* ---------------------------------------------------------
*
*  JOB NUMBER: HC338354c
*
*  PREVIOUS JOB: HC338358
*
*  LANGUAGE: SAS 9.4
*
*  VERSION CONTROL: 
*					04nov25: cc'ed HC338358
							 update job
...
%let job = HC338354c;
%let prg = AQA;
%let impdb = data.HC338353c_imputed_data_04nov25;
%let lf_margin = 0.7in;
%let rg_margin = 0.7in;
