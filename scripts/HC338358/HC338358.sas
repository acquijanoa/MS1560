...
ods rtf file = "&homepath\code\&job.\&job._Table3_&sysdate..rtf" style = manuscrt bodytitle;
%let fs = 11pt;
%let fs_body = 11pt;
%let fs_titles = 11pt;
%let lft_mgn = 0.3in;
...
proc report data = db_join;
	title j=center height=&fs font='times roman' bold "^S={leftmargin=&lft_mgn rightmargin=&rgt_mgn}Table 3. Association among maternal preconception socio-behavioral factors and overweight or obesity, HCHS/SOL FLOR Ancillary Study (n=%qtrim(&n_ids))";
