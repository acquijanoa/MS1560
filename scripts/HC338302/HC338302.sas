...
data allrows;
	...
	toplines(where=(line=13)) /* Alcohol Use, % */
    ALCOHOL_USE_1
    ALCOHOL_USE_2 
    ALCOHOL_USE_3 

    toplines(where=(line=14)) /* Smoking, % */
    CURRENT_SMOKER_1
    CURRENT_SMOKER_0
	...
	toplines(where=(line=15)) /* Phisical activity, % */
    PAG2008YN_1
    PAG2008YN_0

    toplines(where=(line=16)) /* Child */
    toplines(where=(line=17)) /* Sex, % */
...
ods rtf file="&homepath.\scripts\&job.\&job._Table1_&sysdate..rtf" bodytitle style=journal;
	ods escapechar="^"; 
