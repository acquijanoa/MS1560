...
proc report data = db_join;
	...
	footnote6 J=LEFT HEIGHT=10pt FONT='times roman' "{\line \line Job &job run by &prg using FLOR analytic file (HC338353a) on %sysfunc(today(), date9.) at %qtrim(%sysfunc(time(), timeampm.))}";
