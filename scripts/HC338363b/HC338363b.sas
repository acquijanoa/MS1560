...
proc report data = db_join;
	title j=center height=&fs font='times roman' bold "^S={leftmargin=&lft_mgn rightmargin=&rgt_mgn}Table 2. Maternal preconception socio-behavioral factors and child's birth weight-for-gestational-age z-score, HCHS/SOL FLOR Ancillary Study (n=%qtrim(&n_ids))";
