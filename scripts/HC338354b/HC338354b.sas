...
*					04nov25: update input dataset to *_03nov25
							 drop anthropometrics anta10a, height and bmi
							 job 54 will use the continuous versions of pct_mvpa slpdur	
							 drop income_c2, lang_pref and provpct from models
							 redefine models
							 update response. It uses WAZ now
							 adjust by yrs_btwn_v1flor instead of yrsv1birth
					12nov25: update input dataset to *_12nov25
							 from model 2, sldur_lt8hrs, pag2008yn and hei2010_c3 are in the model
					18nov25: update row labels and footnote 
							 portrait orientation
							 LOW is the ref value for HEI2010 now
					...
					24jun26: Copy from HC338354 -- collapse background
...
proc genmod data = &impdb;
	...
	model waz = centernum yrs_btwn_v1flor age bkgrd1_c3nomiss n_hc education_c3 parity_v1 employedyn marital_status_c2 yrsus_c3 / d=normal;
...
proc genmod data = &impdb;
	...
	model waz = centernum yrs_btwn_v1flor age bkgrd1_c3nomiss n_hc education_c3 parity_v1 employedyn marital_status_c2 yrsus_c3
